  ...
  <el-card>
    ...
    <el-row class="container">
      ...
      <el-col :span="22" class="item-container">
        ...
        <el-icon
          v-auth="[ButtonPermission.Apartment.Attribute.Payment.Add]"
...
const deleteHandle = async (item: PaymentInfoInterface) => {
  ...
  if (
    !useAuthButtons().BUTTONS.value[
      ButtonPermission.Apartment.Attribute.Payment.Remove
    ]
  ) {
...
const editHandle = (item: PaymentInfoInterface) => {
  ...
  if (
    !useAuthButtons().BUTTONS.value[
      ButtonPermission.Apartment.Attribute.Payment.Update
    ]
  ) {
